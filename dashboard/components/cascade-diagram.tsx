...
const STEPS: Record<Mode, Step[]> = {
  happy: [
    {
      ...
      title: "Cover bound",
      detail:
        "The client pays the premium. It lands in the underwriter's PolicyPool inside the CAP pay-tx: atomically, not as a follow-up transfer.",
      edges: ["e1"],
      tone: "lime",
    },
    {
      ...
      title: "Auto-hedge",
      detail:
        "Unprompted, the underwriter opens its own CAP order against the reinsurer and cedes half the risk. The underwriter just became a requester.",
      edges: ["e2"],
      tone: "lime",
    },
    {
      ...
      t: "T+9.6s",
      title: "Worker hired",
      detail: "Only now does the client hire the worker. The policy already exists.",
      edges: ["e3"],
      tone: "lime",
    },
    {
      ...
      title: "Delivered",
      detail:
        "The worker delivers. Nobody claims. The underwriter keeps its net premium, the reinsurer keeps its cede.",
      edges: ["e4"],
      tone: "lime",
    },
  ],
  discharge: [
    ...
    },
    {
      ...
      t: "T+4.1s",
      title: "Auto-hedge",
      detail: "The underwriter cedes 50% quota-share to the reinsurer. Its own worst case is now half.",
      edges: ["e2"],
      tone: "lime",
    },
    {
      ...
      t: "T+9.6s",
      title: "Worker hired",
      detail: "The client hires the worker for the job it actually wanted done.",
      edges: ["e3"],
      tone: "lime",
    },
    {
      ...
      title: "Worker fails",
      detail:
        "The worker misses the SLA. CAP moves the order to terminal status rejected. That status is the whole oracle.",
      edges: ["e5"],
      tone: "danger",
    },
    {
    ...
    },
    {
      ...
      detail:
        "The reinsurer reimburses the underwriter for its share. Loss lands split across two balance sheets. The client never felt it.",
      edges: ["e7"],
      tone: "lime",
    },
  ],
